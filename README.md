...
| 页面 | URL | 说明 |
|---|---|---|
| 首页 | `http://localhost:8000/` | 选择房间和身份 |
| 用户聊天室 | `http://localhost:8000/room/<房间名>/?username=<用户名>` | 普通用户聊天 |
| 脚本管理面板 | `http://localhost:8000/script/<房间名>/` | 脚本管理员后台 |
...
浏览器打开 `https://你的域名.com/`，应该能看到聊天室首页。
